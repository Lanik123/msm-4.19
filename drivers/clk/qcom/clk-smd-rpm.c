...
/* msm8940 SMD clocks */
DEFINE_CLK_SMD_RPM_BRANCH(msm8940, bi_tcxo, bi_tcxo_ao, QCOM_SMD_RPM_MISC_CLK, 0, 19200000);
DEFINE_CLK_SMD_RPM(msm8940, pnoc_clk, pnoc_a_clk, QCOM_SMD_RPM_BUS_CLK, 0);
DEFINE_CLK_SMD_RPM(msm8940, ipa_clk, ipa_a_clk, QCOM_SMD_RPM_IPA_CLK, 0);
DEFINE_CLK_SMD_RPM(msm8940, snoc_clk, snoc_a_clk, QCOM_SMD_RPM_BUS_CLK, 1);
DEFINE_CLK_SMD_RPM(msm8940, bimc_clk, bimc_a_clk, QCOM_SMD_RPM_MEM_CLK, 0);
DEFINE_CLK_SMD_RPM(msm8940, sysmmnoc_clk, sysmmnoc_a_clk, QCOM_SMD_RPM_BUS_CLK, 2);
DEFINE_CLK_SMD_RPM_QDSS(msm8940, qdss_clk, qdss_a_clk, QCOM_SMD_RPM_MISC_CLK, 1);
DEFINE_CLK_SMD_RPM_XO_BUFFER(msm8940, bb_clk1, bb_clk1_a, 1);
DEFINE_CLK_SMD_RPM_XO_BUFFER(msm8940, bb_clk2, bb_clk2_a, 2);
DEFINE_CLK_SMD_RPM_XO_BUFFER(msm8940, rf_clk2, rf_clk2_a, 5);
DEFINE_CLK_SMD_RPM_XO_BUFFER(msm8940, div_clk2, div_clk2_a, 0xc);
DEFINE_CLK_SMD_RPM_XO_BUFFER_PINCTRL(msm8940, bb_clk1_pin, bb_clk1_a_pin, 1);
DEFINE_CLK_SMD_RPM_XO_BUFFER_PINCTRL(msm8940, bb_clk2_pin, bb_clk2_a_pin, 2);

static struct clk_hw *msm8940_clks[] = {
	[RPM_SMD_XO_CLK_SRC] = &msm8940_bi_tcxo.hw,
	[RPM_SMD_XO_A_CLK_SRC] = &msm8940_bi_tcxo_ao.hw,
	[RPM_SMD_QDSS_CLK] = &msm8940_qdss_clk.hw,
	[RPM_SMD_QDSS_A_CLK] = &msm8940_qdss_a_clk.hw,
	[RPM_SMD_PNOC_CLK] = &msm8940_pnoc_clk.hw,
	[RPM_SMD_PNOC_A_CLK] = &msm8940_pnoc_a_clk.hw,
	[RPM_SMD_IPA_CLK] = &msm8940_ipa_clk.hw,
	[RPM_SMD_IPA_A_CLK] = &msm8940_ipa_a_clk.hw,
	[RPM_SMD_SNOC_CLK] = &msm8940_snoc_clk.hw,
	[RPM_SMD_SNOC_A_CLK] = &msm8940_snoc_a_clk.hw,
	[RPM_SMD_BIMC_CLK] = &msm8940_bimc_clk.hw,
	[RPM_SMD_BIMC_A_CLK] = &msm8940_bimc_a_clk.hw,
	[RPM_SMD_SYSMMNOC_CLK] = &msm8940_sysmmnoc_clk.hw,
	[RPM_SMD_SYSMMNOC_A_CLK] = &msm8940_sysmmnoc_a_clk.hw,
	[RPM_SMD_BB_CLK1] = &msm8940_bb_clk1.hw,
	[RPM_SMD_BB_CLK1_A] = &msm8940_bb_clk1_a.hw,
	[RPM_SMD_BB_CLK2] = &msm8940_bb_clk2.hw,
	[RPM_SMD_BB_CLK2_A] = &msm8940_bb_clk2_a.hw,
	[RPM_SMD_BB_CLK1_PIN] = &msm8940_bb_clk1_pin.hw,
	[RPM_SMD_BB_CLK1_A_PIN] = &msm8940_bb_clk1_a_pin.hw,
	[RPM_SMD_BB_CLK2_PIN] = &msm8940_bb_clk2_pin.hw,
	[RPM_SMD_BB_CLK2_A_PIN] = &msm8940_bb_clk2_a_pin.hw,
	[RPM_SMD_RF_CLK2] = &msm8940_rf_clk2.hw,
	[RPM_SMD_RF_CLK2_A] = &msm8940_rf_clk2_a.hw,
	[RPM_SMD_DIV_CLK2] = &msm8940_div_clk2.hw,
	[RPM_SMD_DIV_A_CLK2] = &msm8940_div_clk2_a.hw,
	[PNOC_MSMBUS_CLK] = &pnoc_msmbus_clk.hw,
	[PNOC_MSMBUS_A_CLK] = &pnoc_msmbus_a_clk.hw,
	[PNOC_KEEPALIVE_A_CLK] = &pnoc_keepalive_a_clk.hw,
	[SNOC_MSMBUS_CLK] = &snoc_msmbus_clk.hw,
...
static int rpm_smd_clk_probe(struct platform_device *pdev)
{
	...
	if (is_msm8940) {
		ret = clk_vote_bimc(&msm8940_bimc_clk.hw, INT_MAX);
		if (ret < 0)
			return ret;
	}
	...
	if (is_bengal || is_scuba) {
		...
		clk_prepare_enable(msm8940_bi_tcxo_ao.hw.clk);
